        ...
        <>
            <Navbar key={'md'} expand={'md'} className="bg-light py-1" fixed="top">
                <Container key={'lg'} className="" >
                    <Navbar.Brand href="#"><img src={logo} className={`img-fluid ${classes.logoImg}`}></img></Navbar.Brand>
                            ...
                            <Form className="d-flex px-3 my-0 py-0">
                                <InputGroup className="">
                                    <Form.Control
                                        ...
                                        className="py-0"
                                    />
                                    <Button id="basic-addon1" className="py-0" variant="primary"><FontAwesomeIcon icon={faMagnifyingGlass} /></Button>
